...
(function () {
    ...
    const PATHS = {
        ...
        palette: '<path d="M12 3.6a8.4 8.4 0 0 0 0 16.8c1.3 0 1.9-.8 1.9-1.7 0-1.1-.9-1.6-.9-2.6 0-1 .8-1.8 1.9-1.8h1.6a3.9 3.9 0 0 0 3.9-3.9c0-3.8-3.7-6.8-8.4-6.8z"/><circle cx="8.3" cy="11" r="1.1"/><circle cx="11.4" cy="7.9" r="1.1"/><circle cx="15.4" cy="9.2" r="1.1"/>',
